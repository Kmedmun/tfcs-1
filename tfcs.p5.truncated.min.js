/*! p5.js v0.6.0, truncated and minified for specific use (audio recorder only) at TfCS */ 
var p5=function(e,t,i){"boolean"==typeof t&&void 0===i&&(i=t,t=void 0),this._setupDone=!1,this._pixelDensity=Math.ceil(window.devicePixelRatio)||1,this._userNode=t,this._curElement=null,this._elements=[],this._requestAnimId=0,this._preloadCount=0,this._isGlobal=!1,this._loop=!0,this._initializeInstanceVariables(),this._defaultCanvasSize={width:100,height:100},this._events={mousemove:null,mousedown:null,mouseup:null,dragend:null,dragover:null,click:null,dblclick:null,mouseover:null,mouseout:null,keydown:null,keyup:null,keypress:null,touchstart:null,touchmove:null,touchend:null,resize:null,blur:null},this._events.wheel=null,this._loadingScreenId="p5_loading",this._registeredMethods={};for(var o=Object.getOwnPropertyNames(p5.prototype._registeredMethods),s=0;s<o.length;s++){var r=o[s];this._registeredMethods[r]=p5.prototype._registeredMethods[r].slice()}window.DeviceOrientationEvent&&(this._events.deviceorientation=null),window.DeviceMotionEvent&&!window._isNodeWebkit&&(this._events.devicemotion=null),this._start=function(){this._userNode&&"string"==typeof this._userNode&&(this._userNode=document.getElementById(this._userNode));var e=this.preload||window.preload;if(e){var t=document.getElementById(this._loadingScreenId);if(!t)(t=document.createElement("div")).innerHTML="Loading...",t.style.position="absolute",t.id=this._loadingScreenId,(this._userNode||document.body).appendChild(t);for(var i in this._preloadMethods){this._preloadMethods[i]=this._preloadMethods[i]||p5;var o=this._preloadMethods[i];o!==p5.prototype&&o!==p5||(o=this._isGlobal?window:this),this._registeredPreloadMethods[i]=o[i],o[i]=this._wrapPreload(o,i)}e(),this._runIfPreloadsAreDone()}else this._setup(),this._runFrames(),this._draw()}.bind(this),this._runIfPreloadsAreDone=function(){var e=this._isGlobal?window:this;if(0===e._preloadCount){var t=document.getElementById(e._loadingScreenId);t&&t.parentNode.removeChild(t),e._setup(),e._runFrames(),e._draw()}},this._decrementPreload=function(){var e=this._isGlobal?window:this;"function"==typeof e.preload&&(e._setProperty("_preloadCount",e._preloadCount-1),e._runIfPreloadsAreDone())},this._wrapPreload=function(e,t){return function(){return this._incrementPreload(),this._registeredPreloadMethods[t].apply(e,arguments)}.bind(this)},this._incrementPreload=function(){var e=this._isGlobal?window:this;e._setProperty("_preloadCount",e._preloadCount+1)},this._setup=function(){this.createCanvas(this._defaultCanvasSize.width,this._defaultCanvasSize.height,"p2d");var e=this._isGlobal?window:this;if("function"==typeof e.preload)for(var t in this._preloadMethods)e[t]=this._preloadMethods[t][t],e[t]&&this&&(e[t]=e[t].bind(this));"function"==typeof e.setup&&e.setup();for(var i=document.getElementsByTagName("canvas"),o=0;o<i.length;o++){var s=i[o];"true"===s.dataset.hidden&&(s.style.visibility="",delete s.dataset.hidden)}this._setupDone=!0}.bind(this),this._draw=function(){var e=window.performance.now(),t=e-this._lastFrameTime,i=1e3/this._targetFrameRate;(!this._loop||t>=i-5)&&(this.redraw(),this._frameRate=1e3/(e-this._lastFrameTime),this._lastFrameTime=e,void 0!==this._updateMouseCoords&&this._updateMouseCoords()),this._loop&&(this._requestAnimId=window.requestAnimationFrame(this._draw))}.bind(this),this._runFrames=function(){this._updateInterval&&clearInterval(this._updateInterval)}.bind(this),this._setProperty=function(e,t){this[e]=t,this._isGlobal&&(window[e]=t)}.bind(this),this.remove=function(){if(this._curElement){this._loop=!1,this._requestAnimId&&window.cancelAnimationFrame(this._requestAnimId);for(var e in this._events)window.removeEventListener(e,this._events[e]);for(var t=0;t<this._elements.length;t++){var i=this._elements[t];i.elt.parentNode&&i.elt.parentNode.removeChild(i.elt);for(var o in i._events)i.elt.removeEventListener(o,i._events[o])}var s=this;if(this._registeredMethods.remove.forEach(function(e){void 0!==e&&e.call(s)}),this._isGlobal){for(var r in p5.prototype)try{delete window[r]}catch(e){window[r]=void 0}for(var n in this)if(this.hasOwnProperty(n))try{delete window[n]}catch(e){window[n]=void 0}}}}.bind(this),this._registeredMethods.init.forEach(function(e){void 0!==e&&e.call(this)},this);var n=this._createFriendlyGlobalFunctionBinder();if(e)e(this);else{this._isGlobal=!0,p5.instance=this;for(var d in p5.prototype)if("function"==typeof p5.prototype[d]){var a=d.substring(2);this._events.hasOwnProperty(a)||(Math.hasOwnProperty(d)&&Math[d]===p5.prototype[d]?n(d,p5.prototype[d]):n(d,p5.prototype[d].bind(this)))}else n(d,p5.prototype[d]);for(var h in this)this.hasOwnProperty(h)&&n(h,this[h])}for(var l in this._events){var p=this["_on"+l];if(p){var u=p.bind(this);window.addEventListener(l,u,{passive:!1}),this._events[l]=u}}var _=function(){this._setProperty("focused",!0)}.bind(this),v=function(){this._setProperty("focused",!1)}.bind(this);window.addEventListener("focus",_),window.addEventListener("blur",v),this.registerMethod("remove",function(){window.removeEventListener("focus",_),window.removeEventListener("blur",v)}),i?this._start():"complete"===document.readyState?this._start():window.addEventListener("load",this._start.bind(this),!1)};p5.prototype.map=function(e,t,i,o,s,r){var n=(e-t)/(i-t)*(s-o)+o;return r?o<s?this.constrain(n,o,s):this.constrain(n,s,o):n},p5.prototype.constrain=function(e,t,i){return Math.max(Math.min(e,i),t)},p5.prototype._preloadMethods={loadJSON:p5.prototype,loadImage:p5.prototype,loadStrings:p5.prototype,loadXML:p5.prototype,loadShape:p5.prototype,loadTable:p5.prototype,loadFont:p5.prototype,loadModel:p5.prototype,loadShader:p5.prototype},p5.prototype._registeredMethods={init:[],pre:[],post:[],remove:[]},p5.prototype._registeredPreloadMethods={},p5.prototype.registerPreloadMethod=function(e,t){p5.prototype._preloadMethods.hasOwnProperty(e)||(p5.prototype._preloadMethods[e]=t)},p5.prototype.registerMethod=function(e,t){var i=this||p5.prototype;i._registeredMethods.hasOwnProperty(e)||(i._registeredMethods[e]=[]),i._registeredMethods[e].push(t)};
